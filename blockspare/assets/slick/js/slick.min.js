	...
	( r = ( function () {
		...
		( r.prototype.buildArrows = function () {
			...
			e.options.arrows === ! 0 &&
				...
				( e.$nextArrow = n( e.options.nextArrow ).addClass(
					'slick-arrow'
				) ),
				e.slideCount > e.options.slidesToShow
					? ( e.$prevArrow
		...
		( r.prototype.checkResponsive = function ( e, i ) {
			...
			if (
				...
				o !== null
					...
					! e &&
						d !== ! 1 &&
						t.$slider.trigger( 'breakpoint', [ t, d ] );
			}
		} ),
					...
					( k.onload = function () {
						...
						( k.onerror = function () {
							u
								...
								e.$slider.trigger( 'lazyLoadError', [
									e,
									u,
									h,
								] );
		...
		( r.prototype.setCSS = function ( e ) {
			...
			i.options.rtl === ! 0 && ( e = -e ),
				( s =
					i.positionProp == 'left' ? Math.ceil( e ) + 'px' : '0px' ),
				...
				if (
					...
					for ( t in o )
						if ( ! Array.isArray( e.options.responsive ) )
							...
							for (
								i = e.options.responsive.length - 1;
								i >= 0;
		...
		( r.prototype.setSlideClasses = function ( e ) {
			...
			if (
				...
				var d;
				i.options.slidesToShow >= i.$slides.length
					? ( ( d = -1 ),
					  ( t = i.options.slidesToShow = i.$slides.length ) )
					: ( ( d = i.options.slidesToShow % 2 === 0 ? 1 : 0 ),
		...
		( r.prototype.swipeMove = function ( e ) {
			...
			if (
				...
				( i.touchObject.curX =
					c !== void 0 ? c[ 0 ].pageX : e.clientX ),
				( i.touchObject.curY =
					c !== void 0 ? c[ 0 ].pageY : e.clientY ),
				...
				i.options.infinite === ! 1 &&
					( ( i.currentSlide === 0 && o === 'right' ) ||
						( i.currentSlide >= i.getDotCount() &&
							o === 'left' ) ) &&
					( ( a =
						i.touchObject.swipeLength * i.options.edgeFriction ),
					( i.touchObject.edgeHit = ! 0 ) ),
				i.options.vertical === ! 1
					? ( i.swipeLeft = s + a * d )
					: ( i.swipeLeft =
