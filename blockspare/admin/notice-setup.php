            ...
            <div class="bs-welcome-panel-content">
                <div class="bs-welcome-panel-header">
                    <div class="blockspare-notice-info">
                        ...
                        <p class="blockspare-notice-description"><?php esc_html_e('Expert Templates from our Patterns Library - Import, Customize, Publish with Ease!', 'blockspare'); ?></p>  
                        <div class='blockspare-notice-buttons'>
                            ...
                            <a  href="<?php echo admin_url('admin.php?page=blockspare')?>" class="blockspare-notice-button blockspare-notice-button-secondary"><span class="dashicons dashicons-welcome-learn-more"></span> <?php esc_html_e('Gutenberg Blocks Patterns', 'blockspare'); ?></a> 
                        </div>                      
                    </div>
