<?php
if (!function_exists('blockspare_banner_one_control_slider')) {
  function blockspare_banner_one_control_slider($attributes, $blockuniqueclass, $blockName = '')
  {
    ...
    if (!empty($inline_css)) {
      ...
      wp_register_style('bs-banner-one' . $rand, false);
      wp_enqueue_style('bs-banner-one' . $rand);
      wp_add_inline_style('bs-banner-one' . $rand, blockspare_minify_css($inline_css));
    }
  }
}
