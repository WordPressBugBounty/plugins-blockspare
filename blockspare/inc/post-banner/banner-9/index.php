<?php
if (!function_exists('blockspare_banner_nine_control_slider')) {
  function blockspare_banner_nine_control_slider($attributes, $blockuniqueclass, $blockName = '')
  {
    ...
    //slider nav color
    $inline_css .= ' .' . $blockuniqueclass . ' .blockspare-banner-slider-wrapper button:before{
    ...
    //Trending nav color
    $inline_css .= ' .' . $blockuniqueclass . ' .blockspare-banner-trending-carousel-wrapper button:before{
    ...
    if (!empty($inline_css)) {
      ...
      wp_register_style('bs-banner-nine' . $rand, false);
      wp_enqueue_style('bs-banner-nine' . $rand);
      wp_add_inline_style('bs-banner-nine' . $rand, blockspare_minify_css($inline_css));
    }
  }
}
