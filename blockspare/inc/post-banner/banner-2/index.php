<?php
if (!function_exists('blockspare_banner_two_control_slider')) {
  function blockspare_banner_two_control_slider($attributes, $blockuniqueclass, $blockName = '')
  {
    ...
    if (!empty($inline_css)) {
      ...
      wp_register_style('bs-banner-two' . $rand, false);
      wp_enqueue_style('bs-banner-two' . $rand);
      wp_add_inline_style('bs-banner-two' . $rand, blockspare_minify_css($inline_css));
    }
  }
}
